...
def main():
    ...
    parser.add_argument("--model", type=str, default="C:/Users/17850/Desktop/ultralytics-main/runs/train/exp/weights/best.onnx", help='model file')
    parser.add_argument("--dataset", type=str,default="C:/Users/17850/Desktop/ultralytics-main/mydata/YOLO_data/images/test", help='calibration_dataset')
